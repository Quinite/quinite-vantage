        ...
        <div className="h-full bg-gray-50 overflow-y-auto">
            <div className="p-4 md:p-8 max-w-7xl mx-auto">
                <div className="flex flex-col md:flex-row md:items-center justify-between gap-4 mb-8">
                    <div>
                        <h1 className="text-2xl md:text-3xl font-bold tracking-tight text-slate-900">Integrations</h1>
                        <p className="text-sm md:text-base text-slate-500 mt-1">Connect your lead sources and external tools to Vantage.</p>
                    </div>
                </div>
