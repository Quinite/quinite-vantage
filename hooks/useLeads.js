...
export function useLeads(filters = {}) {
    return useQuery({
        ...
        queryFn: async () => {
            ...
            if (filters.projectIds?.length) params.append('project_ids', filters.projectIds.join(','))
            ...
            if (filters.assignedToIds?.length) params.append('assigned_to_ids', filters.assignedToIds.join(','))
            if (filters.interestLevels?.length) params.append('interest_levels', filters.interestLevels.join(','))
